                  ...
                  ($ KeyboardAwareScrollView
                     ...
                     ($ RegisterPageContainer
                        ($ AnimatedView {:style [(tw :relative)
                           ...
                           ;; TABLE-HEADER
                           ($ View {:style [(tw :flex :items-center :justify-center :mt-5 :mb-6 :border-2 :border-purple :border-solid)]}
                              ($ Text {:style [(tw :text-center :text-gray :px-2)
                                               { :font-size 17
                                                :line-height 22}]} "Ovdje ide tablica")
                           ...
                           ;; TABLE-BODY
                           ($ View {:style [(tw :flex :flex-row :mt-5 :mb-6 :border-2 :border-purple :border-solid)]}

                              ($ View {:style [(tw :flex :items-center :justify-center :mt-2 :mb-2 :border-2 :border-purple :border-solid)
                                               :width "33.333333%"]}
